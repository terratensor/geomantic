...
Обеспечивает быстрый полнотекстовый поиск по географическим объектам с поддержкой русской морфологии, геопоиск и иерархическую навигацию.
...
- [x] Базовый импорт данных
- [x] Поддержка русской морфологии
- [x] Иерархия административного деления
- [x] Материализованные пути
- [x] S2 геохеши
...
- Ваше имя - [@audetv](https://github.com/audetv)

## 🙏 Благодарности

- [GeoNames](https://www.geonames.org/) - за предоставленные данные
- [Manticore Search](https://manticoresearch.com/) - за отличный поисковый движок
- [S2 Geometry](http://s2geometry.io/) - за геопространственные алгоритмы
```

Этот README теперь содержит всю информацию о проекте, включая новые возможности с геохешами и детальное описание всех таблиц и запросов.